...
# coq_makefile OTHERFLAGS = -Q . LF COQLIBS =  -install none Preface.v Basics.v Induction.v Lists.v Poly.v Tactics.v Logic.v IndProp.v Maps.v ProofObjects.v IndPrinciples.v Rel.v Imp.v ImpParser.v ImpCEvalFun.v Extraction.v Auto.v Postscript.v Bib.v -o Makefile 
#
...
.merlin:
	...
	@echo "B /Users/bcpierce/home/sf/lf/full" >> .merlin
	@echo "S /Users/bcpierce/home/sf/lf/full" >> .merlin
...
$(addsuffix .d,$(VFILES)): %.v.d: %.v
	$(SHOW)'COQDEP $<'
	$(HIDE)$(COQDEP) -Q . LF $(COQLIBS) "$<" > "$@" || ( RV=$$?; rm -f "$@"; exit $${RV} )
